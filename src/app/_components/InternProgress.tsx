...
import { useUserProgress } from "@/lib/actions/useUserProgress";

interface InternProgressProps {
  userId: string;
}

export default function InternProgress({ userId }: InternProgressProps) {
      ...
      <div>
        ...
        <div>
          <div className='flex justify-between mb-5'>
            ...
            <p>{progress?.progress_value || 0}%</p>
          </div>
          <Progress value={progress?.progress_value || 0} />
        </div>
      </div>
