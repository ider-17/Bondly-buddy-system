...
export default function Onboarding() {
    ...
    return (
        <div className="w-full h-screen flex flex-col gap-10 justify-center items-center bg-slate-50 text-black">
            {currentStep === 1 && (
                <div className="border border-neutral-300 py-5 px-6 space-y-6 rounded-xl bg-white">
                    <div className="flex flex-col items-center">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-neutral-600 text-sm font-medium">Select your favorite topics to make your journey more fun <br /> and personal.</p>
                        </div>
                    </div>
                    ...
                    <div className="text-center flex flex-col items-center">
                        ...
                        <div className="w-[80%] h-[264px] overflow-scroll flex flex-col gap-2 items-center">
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🎬 Movies & TV Shows</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">📚 Books & Reading</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🎨 Art & Design</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🏋️‍♂️ Fitness & Gym</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🤖 AI & Robotics</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🌍 Travel</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🍽️ Cooking & Foodie Adventures</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🗣️ Language Learning</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">👫 Volunteering / Social Impact</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🧘‍♀️ Yoga & Meditation</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🏔️ Hiking & Outdoor Activities</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🥗 Healthy Living</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🧠 Self-improvement</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">💡 Entrepreneurship & Startups</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🎯 Career Goals</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">💻 Technology & Gadgets</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">📱 Mobile Apps / UX & UI</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🚀 Science & Innovation</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🎲 Board Games</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">📸 Photography</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🌿 Plants & Gardening</div>
                            <div className="border border-neutral-300 rounded-full py-2 px-[10px] text-xs font-semibolds w-full">🐶 Pet Lover</div>
                        </div>
                    </div>

                    <div>
                        <h6 className="text-sm font-semibold mb-3">Previous Experience</h6>
                        <textarea placeholder="Tell us about your background and previous experince..." className="w-full py-3 px-6 rounded-xl border border-neutral-300" />
                    </div>
                </div>
            )}
            ...
            {currentStep === 2 && (
                <div className="border border-neutral-300 py-5 px-6 space-y-6 rounded-xl bg-white min-w-[426px]">
                    ...
                    <div>
                        ...
                        <textarea placeholder="Describe your short-term and long-term career goals..." className="border border-neutral-300 rounded-xl py-6 px-3 w-full" />
                    </div>
                </div>
            )}
            ...
            <div>
                ...
                <div className="w-[425px] flex justify-between">
                    ...
                    <div onClick={handleNext} className="flex gap-2 py-[10px] px-4 rounded-xl bg-black text-white items-center cursor-pointer">
                        <p>Next</p>
